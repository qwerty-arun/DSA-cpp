...
int main() {
    // Example usage of the linked list [18]
    List ll;
    ll.pushFront(1);
    ll.pushFront(2);
    ll.pushFront(3);
    std::cout << "Original Linked List: ";
    ll.printLinkedList(); // Output: 3 -> 2 -> 1 -> nullptr [18]

    ll.pushBack(4);
    std::cout << "Linked List after pushBack(4): ";
    ll.printLinkedList(); // Output: 3 -> 2 -> 1 -> 4 -> nullptr [9]

    ll.popFront();
    std::cout << "Linked List after popFront(): ";
    ll.printLinkedList(); // Output: 2 -> 1 -> 4 -> nullptr [10]

    ll.popBack();
    std::cout << "Linked List after popBack(): ";
    ll.printLinkedList(); // Output: 2 -> 1 -> nullptr [12]

    ll.insert(4, 1);
    std::cout << "Linked List after insert(4, 1): ";
    ll.printLinkedList(); // Output: 2 -> 4 -> 1 -> nullptr [15]

    ll.insert(5, 0);
    std::cout << "Linked List after insert(5, 0): ";
    ll.printLinkedList(); // Output: 5 -> 2 -> 4 -> 1 -> nullptr [15]

    ll.insert(6, 3);
    std::cout << "Linked List after insert(6, 3): ";
    ll.printLinkedList(); // Output: 5 -> 2 -> 4 -> 6 -> 1 -> nullptr [15]

    std::cout << "Search for 2: Index = " << ll.search(2) << std::endl; // Output: Search for 2: Index = 1 [20]
    std::cout << "Search for 6: Index = " << ll.search(6) << std::endl; // Output: Search for 6: Index = 3 [20]
    std::cout << "Search for 7: Index = " << ll.search(7) << std::endl; // Output: Search for 7: Index = -1 [20]
